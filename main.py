...
from src.golden_evidence import load_fever_gold_data
...
def main():
    ...
    mode_titles = {
        ...
        "RAG_GOLDEN":        "任务二变体：使用 FEVER 标注 Gold Evidence 原句",
    ...
    try:
        ...
        elif EXPERIMENT_MODE == "RAG_GOLDEN":
            logger.info("加载 FEVER 单跳数据集，并解析 train.jsonl 标注 gold evidence 原句")
            data_list = load_fever_gold_data(sample_size=SAMPLE_SIZE, seed=RANDOM_SEED)
        else:
